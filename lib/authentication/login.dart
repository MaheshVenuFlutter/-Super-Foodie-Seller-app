      ...
      showDialog(
          ...
          builder: (c) {
            return const ErrorDialog(
              message: "Please write email and assword",
            );
          });
    }
  }
    ...
    await FirebaseFirestore.instance
      ...
      if (sanapShot.exists) {
        ...
        await sharedPreferences!
            .setString("email", sanapShot.data()!["sellerEmail"]);
        await sharedPreferences!
            .setString("name", sanapShot.data()!["sellerName"]);
        await sharedPreferences!
            .setString("photoUrl", sanapShot.data()!["sellerAvatarUrl"]);
